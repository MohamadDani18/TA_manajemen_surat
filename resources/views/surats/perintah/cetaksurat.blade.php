...
<body>
	...
	<center>
        ...
        <table width="625">
			<tr>
		       <td>
			       <center><font size="3"> SURAT PERINTAH <br>Nomor: {{$s->no_surat}}</font></center>
		       </td>
		    </tr>
		</table>
		<br>
		...
		<table>
            <tr>
				<td>Nama</td>
				<td width="525">: {{$s->nama}}</td>
			</tr>
			<tr>
				<td>Nip</td>
				<td width="525">: {{$s->nip}}</td>
			</tr>
            <tr>
				<td>Unit Kerja</td>
				<td width="525">: {{$s->unitkerja}}</td>
			</tr>
			<tr>
				<td>Tugas</td>
				<td width="525">: {{$s->tugas}}</td>
			</tr>
			<tr class="text2">
				<td>Hari Tanggal</td>
